...
const Contact = () => {
    ...
    const [modalMessage, setModalMessage] = React.useState("Thanks!");
    let subtitle;
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_k8kojhw', 'template_hz9of3d', form.current, 'R-f6TExaG3mzmFTZr')
            .then((result) => {
                e.target.reset()
                setModalMessage("Thanks!")
                openModal();
            }, (error) => {
                setModalMessage(error.message ? `${error.message}` : "Error! please try again")
                openModal();
            });
    };
    return (
        <section className="contact section" id="contact">
            ...
            <div className="contact__container container grid">
                ...
                <div className="contact__content">
                    <h3 className="contact__title">How can i help you ?</h3>
                    ...
                    <form className="contact__form" ref={form} onSubmit={sendEmail}>
                        ...
                        <div className="contact__form-div contact__form-area">
                            ...
                            <textarea name="message" cols="30" rows="10" className='contact__form-input' placeholder='leave a message'></textarea>
                        </div>
                        <Modal
                            isOpen={modalIsOpen}
                        ...
                        >
                            <h2>{modalMessage}</h2>
                            <button className="button button__modal" onClick={closeModal}>close</button>
                        </Modal>
